...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('file-too-large'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('binary-file'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('file-unwritable'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('file-stale-version'), message: z.string(), details: z.object({ path: z.string() }) }),
