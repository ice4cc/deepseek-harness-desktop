...
import {
  ...
  hostReadTextFileRequestSchema,
  hostWriteTextFileRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'host.writeTextFile': { schema: hostWriteTextFileRequestSchema, invoke: (api, r, signal) => api.host.writeTextFile(r, signal) },
