...
export { DirectoryBrowseError, TextFileWriteError, WorkspaceCreateError, WorkspaceRuntime } from './workspaces/service.ts'
...
export type {
  DirectoryEntry, DirectoryListing, TextFileContent, WrittenTextFile, WorkspaceId, WorkspaceView,
