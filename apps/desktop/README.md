...
| `apps/web/src/main.ts` | preload-bridge shell marker detection (`window.dshDesktop.shell`/`.os`; tags `<html data-shell="desktop" data-os="<platform>">`) + caption-band color reporting to the shell preload | window integration — see above |
