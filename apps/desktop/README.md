...
| `apps/web/src/main.ts` | `?shell=desktop&os=<platform>` marker detection (tags `<html data-shell="desktop" data-os="<platform>">`) + caption-band color reporting to the shell preload | window integration — see above |
