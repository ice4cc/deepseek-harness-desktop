 ...
 */
@Remote('readTextFile') readTextFile(request: TextFileReadRequest, signal: AbortSignal): Promise<TextFileReadValue>
 ...
 */
@Remote('writeTextFile') writeTextFile(request: TextFileWriteRequest, signal: AbortSignal): Promise<TextFileWriteValue>
