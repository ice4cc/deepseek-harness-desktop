...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-doc-panel': { kind: 'none', reason: 'Browser-side document panel; renders and edits workspace files in the browser without changing model context.' },
  'packages/client/ui-think-tag': { kind: 'indirect', reason: 'The control rewrites the draft\'s trailing think tag; the chat template owns the model-visible reasoning-effort effect.' },
  ...
  'packages/client/ui-settings-appearance': { kind: 'none', reason: 'Browser-side appearance settings row; the width override is pure presentation and registers nothing model-facing.' },
  ...
  'packages/session/file-changes': { kind: 'none', reason: 'The projection folds already-logged edit/write tool results into a client-facing read model and registers nothing model-facing.' },
